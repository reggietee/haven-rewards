...
- Vitest: **32 tests pass** across engine, server synchronization, CSV, wheel math and offline operator authorization.
...
Portrait (834 × 1112) stacks form, wheel and gallery with entry above the fold. At 1112 × 500, document scrolling keeps fields, both consent controls and the primary action reachable. The focused-field resize handling does not introduce a panel or sticky overlay. Platinum, Gold, Silver, Bronze, grayscale, sponsor backings and both orientations were visually inspected. Portrait wheel centering and the reduced-motion specificity of the Gold shimmer rule were corrected during QA. Rules version is 2026-09-22.1; consent wording/version and initialized schedules are unchanged. Canvas DPR remains capped at 1.5; no post-processing stack was added.
